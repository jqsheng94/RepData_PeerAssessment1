...
View(activity)
```
Transfer the data into propriate format for analyzing. The date of data should look in the format YYYY-MM-DD.
...
First, we need to find out the number of missing values in the data. (cells with “NA”)
